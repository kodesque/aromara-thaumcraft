...
public class RendererCandleVat extends TileEntitySpecialRenderer<TileCandleVat> {

    @Override
    public void render(TileCandleVat te, double x, double y, double z,
        ...
        if (!te.getSyncedStackInSlot(0).isEmpty()) {
            this.renderFlower(te.getSyncedStackInSlot(0));
        }
