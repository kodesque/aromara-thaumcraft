...
public class GenVishroomHuge extends WorldGenBigMushroom {

    @Override
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        Block block = TCABlocks.vishroom_block;

        int i = rand.nextInt(3) + 4;

        //can this even be safely altered?
        //TODO: try to alter this value after initial functionality check
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 < 256)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (block == TCABlocks.vishroom_block)
                    {
